...
import LessonPlayer from '../../../components/user/videoLessons/LessonPlayer'
import '../../../assest/css/user/videoLessons/playerLessonPage.css'
export default function PlayerLessonPage() {
  ...
  return (
    <div className="player-lesson container">
    <div className="groups-wrapper">
        ...
        <div className="groups-content">
            ...
            <div>
                <LessonPlayer lesson={lesson} type={lessonType}/>
            </div>
        </div>
    </div>
</div>
